...
interface IERC4626 {
    ...
    */
    function withdraw(address to, uint256 underlyingAmount) external returns (uint256 shares);
    ...
    */
    function redeem(address to, uint256 shareAmount) external returns (uint256 value);
