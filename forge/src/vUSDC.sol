...
contract vUSDC is ERC4626, Ownable {
    ...
    //deposit fee
    uint256 public fee;
    bytes32 public immutable _balancerPool = 0x3a4c6d2404b5eb14915041e01f63200a82f4a343000200000000000000000065; //arbitrum balancer vault
    ...
    function value() public view returns (uint256) {
        (uint256 amount, ) = staker.userInfo(0, address(this));
    ...
    function compound() public onlyOwner {
        ...
        if (_stg > 1) {
            IBalancer.SingleSwap memory swapParams = IBalancer.SingleSwap({
            ...
            router.addLiquidity(1, underlying, address(this));
            stake();
