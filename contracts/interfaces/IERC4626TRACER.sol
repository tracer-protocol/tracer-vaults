...
abstract contract IERC4626TRACER is ERC20 {
    /*///////////////////////////////////////////////////////////////
                                Events
    //////////////////////////////////////////////////////////////*/
...
// Sets an approved stategy for the ERC-4626 shares contract.
    function setApprovedStrategy(address strategy) internal virtual returns (bool);
//removes a strategy from approved mapping
    function removeApprovedStrategy(address strategy) internal virtual returns (bool);
//deposits into approved strategy
    function depositStrategy(address strategy, uint256 amount) internal virtual returns (uint256 balance);
//withdraws from approved strategy
    function withdrawFromStrategy(address strategy, uint256 amount) internal virtual returns (uint256 balance);
...
// Checks an address is an approved strategy
    function isStrategy() internal view virtual returns (bool);
